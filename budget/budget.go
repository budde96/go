...
import "fmt"
func main() {
	var gross, tax, pension_rate, pension_extra, investments, rent, food, bills, debt, net, pension_total, left float32
	...
	fmt.Printf("Your net income is %.2f€.\nAfter paying:\n%.2f€ into your pensions,\n%.2f€ in investments\n%.2f€ in rent,\n%.2f€ for food,\n%.2f€ in bills,\n%.2f€ into debts.\nYou have %.2f€ left.\n", net, pension_total, investments, rent, food, bills, debt, left)
}
